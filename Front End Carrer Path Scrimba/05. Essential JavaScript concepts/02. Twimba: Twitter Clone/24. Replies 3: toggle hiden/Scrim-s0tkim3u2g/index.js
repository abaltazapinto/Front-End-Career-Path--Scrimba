...
*/ 
    ...
    if (targetTweetObj.replies.length > 0) {
        console.log("replies higher than 0")
        const replyElement = document.querySelector('.tweet-reply')
        replyElement.classList.toggle('hidden')
        console.log("Replies:", targetTweetObj.replies)
        console.log(replyElement)

    } else {
        console.log("No replies found for replyId:", replyId)
    }
