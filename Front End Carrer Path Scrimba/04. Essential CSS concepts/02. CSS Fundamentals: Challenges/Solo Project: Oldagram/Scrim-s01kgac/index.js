...
const appSettings = {
  databaseURL: "https://oldagram-2079c-default-rtdb.europe-west1.firebasedatabase.app/"
}
...
comments.innerHTML = `<span class=bold >${posts[0].username} </span> <span> ${posts[0].comment}</span> `